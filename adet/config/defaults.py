...
_C.INPUT.FIX_SIZE_H = 512 
_C.INPUT.FIX_SIZE_W = 512 


_C.PHO_ARGS = CN()
_C.PHO_ARGS.JINLOVESPHO = 10


_C.MODEL.DIFFUSION = CN()
_C.MODEL.DIFFUSION.BACKBONE = 'None'
_C.MODEL.DIFFUSION.FREEZE_COMPONENT = "ALL"
_C.MODEL.DIFFUSION.EXTRACT_FEAT = True
...
_C.LOG_ARGS = CN()
_C.LOG_ARGS.LOG_EVERY_N = 100
_C.LOG_ARGS.LOG_NUM_IMG = 4
